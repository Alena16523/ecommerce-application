...
public class DataGenerator {
    ...
    public static void createCustomer(){
        ...
        List<Address> customer1AddressList = new ArrayList<>(); //to combine customer's addresses
    ...
    public static void createCategory(){
        ...
        StaticConstants.CATEGORY_LIST.add(category1); //index 0
        StaticConstants.CATEGORY_LIST.add(category2); //index 1
        StaticConstants.CATEGORY_LIST.add(category3); //index 2
